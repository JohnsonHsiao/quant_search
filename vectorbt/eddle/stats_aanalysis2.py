    ...
    if negative[i]==0:
        if negative[i-1]==0:
            ...
            if negative[i-1]==1:
                ...
                odd7.append(data1d['delta'][i]*100/data1d['open'][i])
                c.append(negative[i-1])
            elif negative[i-1]==8:
                odd8.append(data1d['delta'][i]*100/data1d['open'][i])
                c.append(negative[i-1])
            else:
                odd9.append(data1d['delta'][i]*100/data1d['open'][i])
                c.append(negative[i-1])
...
print(c.count(7)/len(data1d['delta'])*100)
print(c.count(8)/len(data1d['delta'])*100)
print(c.count(9)/len(data1d['delta'])*100)
